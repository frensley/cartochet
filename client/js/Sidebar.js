...
import transForm from 'transForm.js/src/transForm.js';
...
class Sidebar {
    ...
    addLayerConfigEditor(index, map_id, map_config) {
        var self = this,
            layer_idx = index;
